...
class SaludoApp:
    ...
    def __init__(self, root):
        ...
        self.root.configure(bg="#A0303ABE")

        # Label que indica el dato a ingresar
        self.label_nombre = tk.Label(root, text="Ingrese su nombre:", bg="#4AA73D", font=("Verdana", 11))
        ...
        self.boton_saludar = tk.Button(root, text="Saludar", command=self.saludar, bg="#84AE92", fg="white", font=("Verdana", 10, "bold"))
        self.boton_saludar.pack(pady=10)

        # Botón para salir del programa
        self.boton_salir = tk.Button(root, text="Salir", command=self.root.quit, bg="black", fg="white", font=("Verdana", 10, "bold"))
